...
export default function Home() {
	return (
		<main className="min-h-screen bg-[#0a1628]">
			...
			<section className="py-20 bg-gradient-to-b from-[#0a0e27] to-[#1a237e]">
				<div className="max-w-6xl mx-auto px-5">
					<h2 className="text-4xl text-center mb-12 font-normal text-[#ffd54f]">
					...
					<div className="grid md:grid-cols-2 gap-8">
						<div className="p-8 rounded-2xl backdrop-blur-md bg-white/5 border border-white/10">
							<h3 className="text-2xl mb-6 text-white">PAIN POINT ที่เกิดขึ้นในองค์กร</h3>
			...
			<section className="py-20 bg-gradient-to-b from-[#0a0e27] to-[#1a237e]">
				<div className="max-w-6xl mx-auto px-5">
					...
					<div className="grid md:grid-cols-3 gap-8 mb-12">
						{/* Skill Card */}
						<div className="p-8 rounded-2xl backdrop-blur-md bg-white/5 border border-white/10">
							<div className="w-12 h-12 rounded-full mb-4 bg-gradient-to-br from-[#f06292] to-[#ec407a]"></div>
							<h3 className="text-2xl text-white mb-2">ทักษะ (Skill)</h3>
							<p className="text-gray-300">ความซับซ้อนของงาน</p>
						...
						{/* Frequency Card */}
						<div className="p-8 rounded-2xl backdrop-blur-md bg-white/5 border border-white/10">
							<div className="w-12 h-12 rounded-full mb-4 bg-gradient-to-br from-[#66bb6a] to-[#43a047]"></div>
							<h3 className="text-2xl text-white mb-2">ความถี่ (Frequency)</h3>
							<p className="text-gray-300">ยิ่งน้อย ยิ่งเหมาะให้ AI ช่วย</p>
							<div className="mt-4 p-4 rounded-lg bg-white/5">
								<div className="flex justify-between mb-2">
									<span className="text-[#66bb6a]">Craft</span>
									<span className="text-[#ffa726]">Noise</span>
						...
						{/* Risk Card */}
						<div className="p-8 rounded-2xl backdrop-blur-md bg-white/5 border border-white/10">
							<div className="w-12 h-12 rounded-full mb-4 bg-gradient-to-br from-[#ffa726] to-[#ff9800]"></div>
							<h3 className="text-2xl text-white mb-2">ความเสี่ยง (Risk)</h3>
							<p className="text-gray-300">ผลกระทบต่อองค์กร</p>
							<div className="mt-4 p-4 rounded-lg bg-white/5">
								<div className="flex justify-between mb-2">
									<span className="text-[#ffa726]">Noise</span>
									<span className="text-[#66bb6a]">Craft</span>
					...
					{/* Score System */}
					<h3 className="text-3xl text-center mb-8 font-normal text-[#ffd54f]">
						คะแนนรวม & การตัดสินใจ
					</h3>

					<div className="grid md:grid-cols-2 gap-8 mb-8">
						<div className="p-8 rounded-2xl text-center bg-gradient-to-br from-white/10 to-white/5 border border-white/10">
							<div className="text-6xl font-bold mb-4 text-[#ffa726]">4-6</div>
							<h4 className="text-xl mb-2 text-[#ffa726]">Noise - เหมาะกับ AI สามารถช่วยได้ดี</h4>
							<p className="text-gray-300">ลดการพึ่งพาบุคลากร</p>
							<span className="inline-block mt-4 px-4 py-2 rounded-full font-medium text-white bg-gradient-to-r from-[#ffa726] to-[#ff9800]">
								AI ช่วยได้
							</span>
						</div>

						<div className="p-8 rounded-2xl text-center bg-gradient-to-br from-white/10 to-white/5 border border-white/10">
							<div className="text-6xl font-bold mb-4 text-[#66bb6a]">7-9</div>
							<h4 className="text-xl mb-2 text-[#66bb6a]">Craft - คนควรทำ ใช้ความเชี่ยวชาญขั้นสูง</h4>
							<p className="text-gray-300">และต้องการการตัดสินใจจากคน</p>
							<span className="inline-block mt-4 px-4 py-2 rounded-full font-medium text-white bg-gradient-to-r from-[#66bb6a] to-[#43a047]">
								คนควรทำ
							</span>
						</div>
					</div>
					...
					<div className="p-8 rounded-2xl bg-white/5">
						<h4 className="text-xl mb-4 text-[#64b5f6]">ตัวอย่าง</h4>
						<p className="text-gray-200 leading-relaxed">
							การปิดงบการเงิน (3+1+3 = 7) = <span className="px-3 py-1 rounded-full text-white font-medium bg-gradient-to-r from-[#66bb6a] to-[#43a047]">Craft</span><br />
							การ PR ค่าใช้จ่ายตามสัญญา (1+1+2 = 4) = <span className="px-3 py-1 rounded-full text-white font-medium bg-gradient-to-r from-[#ffa726] to-[#ff9800]">Noise</span>
						</p>
					</div>
				</div>
			</section>
			...
			<section className="py-20 bg-[#0a0e27]">
				<div className="max-w-6xl mx-auto px-5">
					...
					<div className="p-8 rounded-2xl mb-12 bg-white/5">
					...
					<div className="grid md:grid-cols-2 gap-12">
						<div className="p-8 rounded-2xl bg-white/5">
							<h3 className="text-2xl mb-8 text-[#64b5f6]">4 ข้อเสนอเชิงนโยบาย</h3>
							...
							<div className="space-y-6">
								{[
									...
									<div key={i} className="flex gap-4 p-6 rounded-xl bg-white/5">
										<div className="w-10 h-10 rounded-full flex items-center justify-center text-white font-bold flex-shrink-0 bg-gradient-to-br from-[#64b5f6] to-[#42a5f5]">
											{i + 1}
										</div>
										<div>
						...
						<div className="p-8 rounded-2xl bg-white/5">
							<h3 className="text-2xl mb-8 text-[#66bb6a]">ประโยชน์ที่จะได้รับ</h3>
							...
							<div className="space-y-6">
								{[
									...
									<div key={i} className="flex gap-4 p-6 rounded-xl bg-white/5">
										<div className="w-10 h-10 rounded-full flex items-center justify-center text-white text-xl flex-shrink-0 bg-gradient-to-br from-[#66bb6a] to-[#4caf50]">
											✓
										</div>
										<div>
											<h4 className="text-white mb-2">{item.title}</h4>
